        ...
        <div class="menu">
            <ul>
                ...
                <?php if (session()->get('logged_in_status') == true) : ?>
                    ...
                    <li class="menu-item"><a href="http://localhost:8080/product/create     " target="">ADD PRODUCT</a></li>
                <?php else : ?>
...
<nav>
        ...
        <li><a href="<?= base_url('/product/all') ?>">All Products</a></li>
    ...
    <section>
        ...
        if ($loginStatus ===  true) {
        ?>
            <h2 style="border: none; height: 1px; text-color: green;">
                <?= $message ?>
        ...
        ?>
            <h2 style="border: none; height: 1px; background-color: red;">
                <?= $message ?>
